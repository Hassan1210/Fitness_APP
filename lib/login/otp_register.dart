...
class OtpRegister extends StatefulWidget {
  OtpRegister({required this.phone});
  ...
  loginUser(String phone) async {
    ...
    _auth.verifyPhoneNumber(
        ...
        verificationCompleted: (AuthCredential credential) async {
          ...
          if (user != null) {
            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>Details(phone: widget.phone)), (route) => false);
          } else {
            print("Error");
          }
  ...
  signIn(String code,dynamic close) async {
    ...
    try {
      ...
      if (user != null) {
        ...
        await ref.doc(widget.phone).set({});
