          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                  ...
                  child:
                      "Enter Your  Phone Number ".text.size(16).black.make()),
              const SizedBox(
                height: 20,
              ),
              Column(
                children: [
                  HStack(
                    [
                      Image.asset('assets/images/flag.png',height: 35,width: 35,),
                      const SizedBox(
                        width: 12,
                      ),
                          ...
                          if (phoneController.text.length == 10) {
                            ...
                            if (check) {
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (context) => OptLogin(
                                          phone: "+92${phoneController.text}",
                                        )),
                              );
                            } else {
                              await Future.delayed(1.milliseconds, close);
                              showMassage("User not Found");
                            }
                          } else {
                  ...
                  "Don't have a account".text.size(16).pink900.makeCentered(),
                  const SizedBox(height: 5,),
                  "Sign up".text.size(18).underline.pink900.makeCentered(),
                  const SizedBox(height: 30,),
                  HStack([
                    "By continuing you accept our ".text.size(16).pink900.makeCentered(),
                    "Privacy Policy".text.size(16).bold.underline.black.makeCentered(),
                  ]),
                  HStack([
                    "our ".text.size(16).pink900.makeCentered(),
                    "Term of use".text.size(16).bold.underline.black.makeCentered(),
                  ])
                ],
              )
            ],
